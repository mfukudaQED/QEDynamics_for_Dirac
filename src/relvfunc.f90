...
!============================================================================ 
function fi6(aa,z,a,r2)
!============================================================================
  implicit none
  complex(kind(0d0)) :: fi6
  complex(kind(0d0)),intent(in) :: a
  double precision,intent(in) :: aa
  double precision,intent(in) :: r2
  double precision,intent(in) :: z

      fi6 = a * z*z*z*z*z*z*dexp(-aa*r2)

end function fi6
!============================================================================ 
function fi51(aa,z,u,a,r2)
!============================================================================
  implicit none
  complex(kind(0d0)) :: fi51
  complex(kind(0d0)),intent(in) :: a
  double precision,intent(in) :: aa
  double precision,intent(in) :: r2
  double precision,intent(in) :: z,u

      fi51 = a * z*z*z*z*z*u*dexp(-aa*r2)

end function fi51
!============================================================================ 
function fi42(aa,z,u,a,r2)
!============================================================================
  implicit none
  complex(kind(0d0)) :: fi42
  complex(kind(0d0)),intent(in) :: a
  double precision,intent(in) :: aa
  double precision,intent(in) :: r2
  double precision,intent(in) :: z,u

      fi42 = a * z*z*z*z*u*u*dexp(-aa*r2)

end function fi42
!============================================================================ 
function fi411(aa,z,u,v,a,r2)
!============================================================================
  implicit none
  complex(kind(0d0)) :: fi411
  complex(kind(0d0)),intent(in) :: a
  double precision,intent(in) :: aa
  double precision,intent(in) :: r2
  double precision,intent(in) :: z,u,v

      fi411 = a * z*z*z*z*u*v*dexp(-aa*r2)

end function fi411
!============================================================================ 
function fi330(aa,z,u,a,r2)
!============================================================================
  implicit none
  complex(kind(0d0)) :: fi330
  complex(kind(0d0)),intent(in) :: a
  double precision,intent(in) :: aa
  double precision,intent(in) :: r2
  double precision,intent(in) :: z,u

      fi330 = a * z*z*z*u*u*u*dexp(-aa*r2)

end function fi330
!============================================================================ 
function fi321(aa,z,u,v,a,r2)
!============================================================================
  implicit none
  complex(kind(0d0)) :: fi321
  complex(kind(0d0)),intent(in) :: a
  double precision,intent(in) :: aa
  double precision,intent(in) :: r2
  double precision,intent(in) :: z,u,v

      fi321 = a * z*z*z*u*u*v*dexp(-aa*r2)

end function fi321
!============================================================================ 
function fi222(aa,z,u,v,a,r2)
!============================================================================
  implicit none
  complex(kind(0d0)) :: fi222
  complex(kind(0d0)),intent(in) :: a
  double precision,intent(in) :: aa
  double precision,intent(in) :: r2
  double precision,intent(in) :: z,u,v

      fi222 = a * z*z*u*u*v*v*dexp(-aa*r2)
