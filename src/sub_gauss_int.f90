...
!      func_dxunpg(x,y,z,posA,alpha,nx,ny,nz)  (added 150913)
!      func_dyunpg(x,y,z,posA,alpha,nx,ny,nz)  (added 150913)
!      func_dzunpg(x,y,z,posA,alpha,nx,ny,nz)  (added 150913)
!      func_unpg(x,y,z,posA,alpha,nx,ny,nz)  (added 110110, mod 150803)
...
!==================================================================
  ...
  elseif(i.eq.3) then ! d/dz
     ...
     stop "i should be 1 or 2 or 3 in func_dunpg."
  end if
...
!==================================================================
function func_dxunpg(x,y,z,posA,alpha,nx,ny,nz)
! x derivative of UNnormalized gaussian function
! center at (Ax,Ay,Az)
!==================================================================
  implicit none

  real(kind=8) :: func_dxunpg
  real(kind=8),intent(in) :: x,y,z,posA(3),alpha
  integer,intent(in) :: nx,ny,nz
  real(kind=8) :: func_unpg

  func_dxunpg = -2.d0*alpha*func_unpg(x,y,z,posA,alpha,nx+1,ny,nz)
  if (nx.ne.0) func_dxunpg = func_dxunpg +nx*func_unpg(x,y,z,posA,alpha,nx-1,ny,nz)

  return
end function func_dxunpg

!==================================================================
function func_dyunpg(x,y,z,posA,alpha,nx,ny,nz)
! y derivative of UNnormalized gaussian function
! center at (Ax,Ay,Az)
!==================================================================
  implicit none

  real(kind=8) :: func_dyunpg
  real(kind=8),intent(in) :: x,y,z,posA(3),alpha
  integer,intent(in) :: nx,ny,nz
  real(kind=8) :: func_unpg

  func_dyunpg = -2.d0*alpha*func_unpg(x,y,z,posA,alpha,nx,ny+1,nz)
  if (ny.ne.0) func_dyunpg = func_dyunpg +ny*func_unpg(x,y,z,posA,alpha,nx,ny-1,nz)

  return
end function func_dyunpg

!==================================================================
function func_dzunpg(x,y,z,posA,alpha,nx,ny,nz)
! z derivative of UNnormalized gaussian function
! center at (Ax,Ay,Az)
!==================================================================
  implicit none

  real(kind=8) :: func_dzunpg
  real(kind=8),intent(in) :: x,y,z,posA(3),alpha
  integer,intent(in) :: nx,ny,nz
  real(kind=8) :: func_unpg

  func_dzunpg = -2.d0*alpha*func_unpg(x,y,z,posA,alpha,nx,ny,nz+1)
  if (nz.ne.0) func_dzunpg = func_dzunpg +nz*func_unpg(x,y,z,posA,alpha,nx,ny,nz-1)

  return
end function func_dzunpg
...
!  twoele = c_PAB*c_QCD*twoele
  ...
  deallocate(d1,d2,e1,e2,f1,f2)
  deallocate(R, list_R000j)
