...
!           write (*,'(i4,a3,3x,i1,3x,a4,2x,4e22.14)') bnum, L, num, Angu, tmpA, tmpB
           ...
           read (42,'(i4,a3,3x,i1,3x,a4,2x,4e22.14)') bnum, L, num, Angu, tmpA, tmpB
        else if((SYMM.eq.3).or.(SYMM.eq.4)) then
...
!==============================================================================
      ...
      if (Angu .eq. 's   ') then
         ...
         ns = 83
      else if (Angu .eq. 'k700') then
         ns = 84
      else if (Angu .eq. 'k610') then
         ns = 85
      else if (Angu .eq. 'k601') then
         ns = 86
      else if (Angu .eq. 'k520') then
         ns = 87
      else if (Angu .eq. 'k511') then
         ns = 88
      else if (Angu .eq. 'k502') then
         ns = 89
      else if (Angu .eq. 'k430') then
         ns = 90
      else if (Angu .eq. 'k421') then
         ns = 91
      else if (Angu .eq. 'k412') then
         ns = 92
      else if (Angu .eq. 'k403') then
         ns = 93
      else if (Angu .eq. 'k340') then
         ns = 94
      else if (Angu .eq. 'k331') then
         ns = 95
      else if (Angu .eq. 'k322') then
         ns = 96
      else if (Angu .eq. 'k313') then
         ns = 97
      else if (Angu .eq. 'k304') then
         ns = 98
      else if (Angu .eq. 'k250') then
         ns = 99
      else if (Angu .eq. 'k241') then
         ns = 100
      else if (Angu .eq. 'k232') then
         ns = 101
      else if (Angu .eq. 'k223') then
         ns = 102
      else if (Angu .eq. 'k214') then
         ns = 103
      else if (Angu .eq. 'k205') then
         ns = 104
      else if (Angu .eq. 'k160') then
         ns = 105
      else if (Angu .eq. 'k151') then
         ns = 106
      else if (Angu .eq. 'k142') then
         ns = 107
      else if (Angu .eq. 'k133') then
         ns = 108
      else if (Angu .eq. 'k124') then
         ns = 109
      else if (Angu .eq. 'k115') then
         ns = 110
      else if (Angu .eq. 'k106') then
         ns = 111
      else if (Angu .eq. 'k070') then
         ns = 112
      else if (Angu .eq. 'k061') then
         ns = 113
      else if (Angu .eq. 'k052') then
         ns = 114
      else if (Angu .eq. 'k043') then
         ns = 115
      else if (Angu .eq. 'k034') then
         ns = 116
      else if (Angu .eq. 'k025') then
         ns = 117
      else if (Angu .eq. 'k016') then
         ns = 118
      else if (Angu .eq. 'k007') then
         ns = 119
      else if (Angu .eq. 'k700') then
         ns = 120
      else if (Angu .eq. 'k610') then
...
!     write(*,*) j,nx_S(j),ny_S(j),nz_S(j)
    ...
    nmax(1) = max(maxval(nx_L(1:NBS_L)+2), maxval(nx_S(1:NBS_S)+2))
    nmax(2) = max(maxval(ny_L(1:NBS_L)+2), maxval(ny_S(1:NBS_S)+2))
    nmax(3) = max(maxval(nz_L(1:NBS_L)+2), maxval(nz_S(1:NBS_S)+2))
