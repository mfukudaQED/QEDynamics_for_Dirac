...
!============================================================
function intVT_mat(p,a,q,b)
! Integration of kinetic and nuclear integral T+V
! p,q : labels for molecular orbitals.
! a,b : labels for electron/positron ("+"/"-")
!
! 131123  
!============================================================
  ...
  complex(kind=dp) :: intT_mat,intV_mat

  intVT_mat = intT_mat(p,a,q,b)+intV_mat(p,a,q,b)

  return
end function intVT_mat
...
!  intM_mat =   0.02_dp*intM_mat
!  intM_mat =   2._dp*intM_mat
